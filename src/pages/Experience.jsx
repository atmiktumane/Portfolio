      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="w-full bg-zinc-900 px-4 py-6 rounded-2xl hover:shadow-2xl hover:shadow-purple-500/20">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-1 text-zinc-400 text-md">
                  <SlLocationPin />{" "}
                  <span className="!text-sm">Pune (Hybrid)</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-5 flex flex-col gap-1">
            <div className="flex items-center gap-1 text-sm">
              {" "}
              <TbPointFilled /> Improved application performance by 35% through
              component optimization and bug resolution.
            </div>
            <div className="flex items-center gap-1 text-sm">
              {" "}
              <TbPointFilled /> Reduced production issues through improved error
              handling and validation mechanisms.
            </div>
            <div className="flex items-center gap-1 text-sm">
              {" "}
              <TbPointFilled /> Increased deployment reliability through better
              modularization and streamlined processes.
            </div>
          </div>
        </div>
        ...
        <div className="w-full bg-zinc-900 px-4 py-6 rounded-2xl hover:shadow-2xl hover:shadow-purple-500/20">
          <div className="flex items-start gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-1 text-zinc-400 text-xl">
                  <CiCalendar />{" "}
                  <span className="!text-sm">Sept 2023 - Feb 2024</span>
                </div>
                <div className="flex items-center gap-1 text-zinc-400 text-md">
                  <SlLocationPin /> <span className="!text-sm">Hyderabad</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-5 flex flex-col gap-1">
            <div className="flex items-center gap-1 text-sm">
              {" "}
              <TbPointFilled /> Enhanced system efficiency and scalability,
              reducing load times by 30% and improving response speed.
            </div>
            <div className="flex items-center gap-1 text-sm">
              {" "}
              <TbPointFilled /> Strengthened product usability and consistency,
              leading to boost in user satisfaction scores.
            </div>
            <div className="flex items-center gap-1 text-sm">
              {" "}
              <TbPointFilled /> Accelerated feature delivery by 20% through
              collaboration in Agile sprints and efficient task planning.
            </div>
          </div>
        </div>
      </div>
